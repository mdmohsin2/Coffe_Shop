        ...
        <div>
            <footer className="footer text-center mx-auto p-10 bg-neutral text-neutral-content">
                <div>
                    ...
                    <a href='/ ' className="link link-hover">Espresso</a>
                    <a href='/ ' className="link link-hover">Cappuccino</a>
                    <a href='/ ' className="link link-hover">Americano</a>
                </div>
                <div>
                    <span className="footer-title">Contact me</span>
                    <a href='/ ' className="link link-hover">Email: mohsinbd862554@gmail.com</a>
                    <a href='/ ' className="link link-hover">Phone: 01884008408</a>
                </div>
                <div>
